...
public class GenemapConverter {
    ...
    public static void run(
            @Nullable Path inputOmim, @Nullable Path inputCgd, Path inputHpo, @Nullable Path inputIncompletePenetrance, Path output) {
    ...
    private static Set<HpoInheritanceMode> convertoToHpoBasedInheritance(
        ...
        phenotypes.stream()
                ...
                .forEach(
                        phenotype ->
                                Optional.ofNullable(omimHpoMapping
                                                .get(phenotype.getOmimId())).orElseThrow(() -> new NoSuchElementException(phenotype.getOmimId()))
                                        .forEach(
                                                hpo ->
                                                        result.add(
